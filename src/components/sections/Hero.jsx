    ...
    <section className="bg-white">
      <div className="container grid lg:grid-cols-2 gap-18 lg:gap-22 items-center py-28">
        <div className="lg:pr-18">
          ...
          <h2 className="mt-4 text-4xl lg:text-[56px] font-extra leading-tight tracking-[-0.02em]">Design that moves business forward</h2>
          <p className="mt-6 text-neutral-700 max-w-2xl text-lg lg:text-[18px] leading-relaxed">Vincent helps product teams craft clear experiences and scalable design systems that convert. We combine product strategy, research, and pixel-perfect interfaces to deliver measurable outcomes.</p>
